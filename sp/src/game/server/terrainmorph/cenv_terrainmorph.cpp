...
private:
	...
	CNetworkVar(float, m_flDeltaZ);
	CNetworkVar(float, m_flDieTime);
	CNetworkVar(float, m_flRadius);
	CNetworkVar(float, m_flDeltaRadius);
	CNetworkVar(float, m_flStrength);
	CNetworkVar(float, m_flDeltaStrength);

	CNetworkVar(float, m_flDuration);
	CNetworkVar(float, m_flStartTime);
	CNetworkVar(float, m_flStartRadius);
	CNetworkVar(float, m_flGoalRadius);

	CNetworkVar(float, m_flFraction);
...
IMPLEMENT_SERVERCLASS_ST(CTerrainMorph, DT_TerrainMorphing)
SendPropFloat(SENDINFO(m_flDeltaZ))
END_SEND_TABLE()
//---------------------------------------------------------
//---------------------------------------------------------
...
{
	m_Params = params;
	m_flDeltaZ = m_Params.m_flDeltaZ;
	SetThink( NULL );
}
