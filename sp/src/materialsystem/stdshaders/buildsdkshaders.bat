...
%BUILD_SHADER% stdshader_dx9_20b_lightmap		-game %GAMEDIR% -source %SOURCEDIR%
%BUILD_SHADER% stdshader_dx9_30_lightmap			-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30 
